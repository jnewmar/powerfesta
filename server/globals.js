...
//  	console.log("MAIL URL "+process.env.MAIL_URL);
	Accounts.emailTemplates.siteName = "PowerFesta";
	Accounts.emailTemplates.from = "Contato PowerFesta <contato.easyfesta@gmail.com>";
	Accounts.emailTemplates.verifyEmail.subject = function (user) {
	    return "Bem Vindo ao Power Festa, " + user.profile.name;
	};
...
*/
    ...
    url_pix=process.env.ROOT_URL+"pix.png";
	   ...
	   return "Ola,"+ user.profile.name+",<br><br>"+
			"Seja muito bem vindo ao Power Festa.<br>"+
